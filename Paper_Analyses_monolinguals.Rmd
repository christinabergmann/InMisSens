---
title: "MP MetaAnalysis Monolinguals"
...
db_ET <- db_ET %>%
  ...
  filter(mean_age_months < 31, infant_type == "typical")
...
aov.type <- anova(rma_Location)

sum_eff <- round(coef(summary(rma_Location))[2,], 2)
